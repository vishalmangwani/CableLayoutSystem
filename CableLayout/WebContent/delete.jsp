...
%>
	...
	<div style="float:left;">
		...
		<table>
			<tr>
				<th><font color=#151B54 face="cursive, sans-serif" size=2><strong><br><br><br><br>Enter the sector number, details of which you required:</strong></font><input type="text" name=sec></th>
			</tr>
			<tr>
