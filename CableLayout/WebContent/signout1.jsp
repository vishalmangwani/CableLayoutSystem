...
<body class="pageback">
	...
	try
	{
		String emp= (String)session.getAttribute("eid");
		String psword= (String)session.getAttribute("pass");
		String sec1= (String)session.getAttribute("sec");
		...
		PreparedStatement ps1=con.prepareStatement("insert into bhargav.user_id_pass(eid,password) values(?,?)");
		ps1.setString(1, emp);
		ps1.setString(2, psword);
		int rs1=ps1.executeUpdate();
		PreparedStatement ps2=con.prepareStatement("insert into bhargav.user_sector(eid,sector) values(?,?)");
		ps2.setString(1, emp);
		ps2.setString(2, sec1);
	...
	<center>
		...
		<div style="float:left;"><br><br><br><a><font color=white size="4">
		<font color=white><strong>Your id is registered....</strong></font><br><br><br><br>
		<b><br>Sign Up here...!!</b></font></a><br><br><br>
		<table align="right">
